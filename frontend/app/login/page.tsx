      ...
      <Card className="w-full max-w-md shadow-2xl border-0 bg-white/95 backdrop-blur-sm">
        <CardHeader className="space-y-2 text-center pb-8">
          ...
          <CardDescription className="text-foundation-bronze">
            Fundación - Control de Almacenes
          </CardDescription>
        </CardHeader>
        <CardContent>
          ...
          <div className="mt-8 p-4 bg-foundation-cream/50 rounded-lg">
            ...
            <div className="text-xs text-foundation-bronze space-y-1">
              <p><strong>Admin:</strong> lorena@fundacion.org / admin123</p>
              <p><strong>Admin:</strong> lilith@fundacion.org / admin123</p>
              <p><strong>Empleado:</strong> empleado@fundacion.org / admin123</p>
            </div>
          </div>
        </CardContent>
      </Card>

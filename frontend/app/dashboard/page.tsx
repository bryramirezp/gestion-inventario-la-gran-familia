...
export default function Dashboard() {
  ...
  const monthlyMovements = movements.filter(movement => 
    new Date(movement.date).getMonth() === new Date().getMonth()
  ).length;
  ...
  const dashboardCards = [
    {
      ...
      bgColor: 'bg-foundation-orange/10',
    },
    {
      title: 'Stock Bajo',
      value: lowStockItems,
    ...
    {
      title: 'Valor Donaciones',
      value: `$${totalDonationValue.toFixed(2)}`,
      change: '+15%',
      icon: DollarSign,
      ...
      <div className="space-y-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Estado actual de los almacenes principales
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                <div className="flex items-center justify-between p-3 bg-foundation-cream/30 rounded-lg">
                  <div className="flex items-center">
                    <ChefHat className="h-5 w-5 text-foundation-orange mr-3" />
                    <div>
                ...
                <div className="flex items-center justify-between p-3 bg-foundation-cream/30 rounded-lg">
                  <div className="flex items-center">
                    <ShoppingCart className="h-5 w-5 text-foundation-gold mr-3" />
                    <div>
                      <p className="font-medium">Bazar</p>
                ...
                <div className="flex items-center justify-between p-3 bg-foundation-cream/30 rounded-lg">
                  <div className="flex items-center">
                    <Package className="h-5 w-5 text-foundation-bronze mr-3" />
                    <div>
                      <p className="font-medium">Almacén General</p>
                      <p className="text-sm text-gray-500">Reserva general</p>
                    </div>
                  </div>
                  <Badge variant="outline" className="text-green-600 border-green-600">
                    Activo
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Últimos movimientos y cambios en el sistema
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
